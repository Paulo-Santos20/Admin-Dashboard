...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const description = initialData ? 'Edit a product.' : 'Adicionar um novo produto.';
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                  ...
                  <div className="space-y-1 leading-none">
                    ...
                    <FormDescription>
                      O produto irá aparecer na página principal
                    </FormDescription>
                  </div>
                </FormItem>
              )}
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                  ...
                  <div className="space-y-1 leading-none">
                    ...
                    <FormDescription>
                      O produto não irá aparecer em nenhum local da loja
                    </FormDescription>
                  </div>
                </FormItem>
              )}
